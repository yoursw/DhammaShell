...
COMPASSIONATE_RESPONSE = (
    "I hear your pain, and I want you to know that you're not alone in this journey."
)
...
def test_integration_scenario():
    ...
    assert (
        len(exported_metrics) == 3
    )  # emotional_recognition, compassion_score, mindfulness_level
